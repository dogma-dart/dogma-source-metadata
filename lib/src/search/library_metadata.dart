...
/// Queries the [library] for metadata with the given [name].
Metadata/*=T*/
    metadataByNameQuery/*<T extends Metadata>*/(LibraryMetadata library,
                                                String name,
                                               {bool includeImports: defaultInclude,
                                                bool includeExports: defaultInclude,
                                                bool includeClasses: defaultInclude,
...
/// Queries the [library] for metadata with the given [type].
Metadata/*=T*/
    metadataByTypeQuery/*<T extends Metadata>*/(LibraryMetadata library,
                                                TypeMetadata type,
                                               {bool includeImports: defaultInclude,
                                                bool includeExports: defaultInclude,
                                                bool includeClasses: defaultInclude,
