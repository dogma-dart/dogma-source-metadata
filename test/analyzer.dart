...
import 'src/analyzer/deprecated_annotation_test.dart' as deprecated_metadata_test;
import 'src/analyzer/enum_metadata_test.dart' as enum_metadata_test;
...
import 'src/analyzer/uri_referenced_metadata_test.dart' as uri_referenced_metadata_test;
...
void main() {
  ...
  group('Deprecated', deprecated_metadata_test.main);
  ...
  group('UriReferencedMetadata', uri_referenced_metadata_test.main);
}
